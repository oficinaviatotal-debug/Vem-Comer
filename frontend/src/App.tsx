...
export default function App() {
  const companySlug = new URLSearchParams(window.location.search).get("empresa");
    ...
    async function loadData() {
      try {
        ...
        const [productsData, menusData] = await Promise.all([
          fetchProducts(companyData.id),
          fetchMenus(companyData.id),
        ]);
  ...
  async function handleOrderSubmit() {
    if (!companyId) {
      setOrderMessage("Estabelecimento não encontrado.");
      return;
    }
  ...
  async function handleFeedbackSubmit(e: React.FormEvent) {
    ...
    if (!companyId) {
      setFeedbackMessage("Estabelecimento não encontrado.");
      return;
    }
          ...
          >
            <span
              className={`hamburger-bar ${
                menuOpen ? "bar-top-open" : ""
              }`}
            ></span>
            <span
              className={`hamburger-bar ${
                menuOpen ? "bar-mid-open" : ""
              }`}
            ></span>
            <span
              className={`hamburger-bar ${
                menuOpen ? "bar-bot-open" : ""
              }`}
            ></span>
          </button>
            ...
            {isAdminMode && localStorage.getItem("token") ? (
              <>
                ...
                <a
                  ...
                  onClick={() => {
                    const el =
                      document.getElementById("admin-tab-pedidos");
                    el?.click();
                    setMenuOpen(false);
                  }}
                >
                ...
                <a
                  ...
                  onClick={() => {
                    const el =
                      document.getElementById("admin-tab-produtos");
                    el?.click();
                    setMenuOpen(false);
                  }}
                >
                ...
                <a
                  ...
                  onClick={() => {
                    const el =
                      document.getElementById("admin-tab-categorias");
                    el?.click();
                    setMenuOpen(false);
                  }}
                >
                ...
                <a
                  ...
                  onClick={() => {
                    const el =
                      document.getElementById("admin-tab-mesas");
                    el?.click();
                    setMenuOpen(false);
                  }}
                >
                ...
                <button
                  ...
                  onClick={() => {
                    const el =
                      document.getElementById("admin-btn-logout");
                    el?.click();
        ...
        {isAdminMode ? (
          ...
          >
            ...
            <p style={{ color: "var(--text-muted)" }}>
              ID do Pedido: <small>{activeOrder.id}</small>
            </p>
            ...
            >
              ...
              <strong>
                R$ {Number(activeOrder.total_price).toFixed(2)}
              </strong>
            </div>
          ...
          <>
            ...
            >
              ...
              <p className="hero-section__subtitle">
                Consulte o cardápio, escolha seus produtos e faça
                seu pedido de forma rápida.
              </p>
